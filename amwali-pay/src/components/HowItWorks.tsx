...
export function HowItWorks() {
  ...
  return (
    <section id="how" className="bg-navy py-20 lg:py-28 relative overflow-hidden">
      <div
        aria-hidden
        className="absolute inset-0 opacity-[0.04]"
        style={{
          backgroundImage:
            'radial-gradient(circle, rgba(201,153,43,1) 1px, transparent 1.5px)',
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p
            className="font-arabic text-base text-gold/80 mt-2"
            lang="ar"
            dir="rtl"
          >
            كيف يعمل أموالي
        ...
        <div ref={containerRef} className="relative">
          ...
          <motion.div
            ...
            className="hidden md:block absolute top-7 left-[12.5%] right-[12.5%] h-[2px] bg-gold z-10"
            aria-hidden
          />
          ...
          <div className="relative z-20 grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-6">
            {HOW_STEPS.map((step, idx) => (
              ...
              >
                <div className="mx-auto w-14 h-14 rounded-full bg-gold grid place-items-center text-navy font-bold text-lg">
                  {step.n}
                </div>
                <h3 className="mt-4 text-sm font-bold text-white">{step.titleEn}</h3>
                <p
                  className="text-xs font-arabic text-gold/85 mt-0.5"
                  lang="ar"
                  dir="rtl"
                >
                  {step.titleAr}
